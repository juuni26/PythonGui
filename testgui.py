...
class PyQtApp(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Welcome To MOBA LEJEN")
        self.setWindowIcon(QtGui.QIcon("bell1.png"))
    ...
    def on_but2(self):
        ...
        try:
            ...
            self.lb1.setPixmap(img.scaledToWidth(
...
#source :https://www.zeolearn.com/magazine/10-steps-for-getting-started-guis-with-python
# different : using if __name__ =" __main__" or not : https://stackoverflow.com/questions/419163/what-does-if-name-main-do
